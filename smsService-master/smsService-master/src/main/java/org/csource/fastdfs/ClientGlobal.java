...
public class ClientGlobal {
    ...
    public static final Logger log = LogManager.getLogger(ClientGlobal.class);

    private ClientGlobal() {
    }

    public static void init(String conf_filename) throws IOException, MyException {
        log.info(conf_filename);
    ...
    public static void initByTrackers(String trackerServers) throws IOException, MyException {
        ...
        InetSocketAddress[] trackerAddresses = (InetSocketAddress[])list.toArray(new InetSocketAddress[list.size()]);
    ...
    public static String configInfo() {
        ...
        if (g_tracker_group != null) {
            ...
            InetSocketAddress[] var2 = trackerAddresses;
            int var3 = trackerAddresses.length;

            for(int var4 = 0; var4 < var3; ++var4) {
                InetSocketAddress inetSocketAddress = var2[var4];
